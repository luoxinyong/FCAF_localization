...
extern double filter_size_surf_min, filter_size_map_min, filter_size_show_min, filter_size_save_min, fov_deg;
...
extern bool ifLoop, ifPCL;
extern double mappingProcessInterval;
extern double kdtreeResetDistance, kdtreeResetTime;
extern double loopHeightMax, loopHeightMin;
extern int currentKeyframeSearchNum;
extern double historyKeyframeSearchRadius, historyKeyframeFitnessScore, historyKeyframeSearchTimeDiff, surroundingkeyframeAddingDistThreshold, surroundingkeyframeAddingAngleThreshold;
extern int historyKeyframeSearchNum;

extern bool ifFloorDetect;
extern double detect_rate;

extern int scan_save_interval;
extern bool detect_object_en;
